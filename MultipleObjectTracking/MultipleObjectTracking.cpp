...
void drawObject(vector<Sample> TheSamples,Mat &frame){

	for(int i=0; i<TheSamples.size(); i++){

		TheSamples.at(i).getxPos();
		TheSamples.at(i).getyPos();
		TheSamples.at(i).getarea();

	cv::circle(frame,cv::Point(TheSamples.at(i).getxPos(),TheSamples.at(i).getyPos()),10,cv::Scalar(0,0,255));
	cv::putText(frame,intToString(TheSamples.at(i).getxPos())+ " , " + intToString(TheSamples.at(i).getyPos()),cv::Point(TheSamples.at(i).getxPos(),TheSamples.at(i).getyPos()+20),1,1,Scalar(0,255,0));
	cv::putText(frame,TheSamples.at(i).getType(),cv::Point(TheSamples.at(i).getxPos(),TheSamples.at(i).getyPos()-30),1,2,TheSamples.at(i).getColor());

	cv::putText(frame,intToString(TheSamples.at(i).getarea()),cv::Point(TheSamples.at(i).getxPos(),TheSamples.at(i).getyPos()-20),1,1,Scalar(0,255,0));
}
}
